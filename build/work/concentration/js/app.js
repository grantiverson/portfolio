...
const makeDeckArray = function() {
    ...
    for (let i = 0; i < deck.length; i++) {                             // iterates through li items and stores their HTML as an array element
        ...
        for (let j = 0; j < deck.length; j++) {                         // iterates through array elements and adds event listeners
            deck[j].addEventListener('click', showCard);
        }
    }
}
